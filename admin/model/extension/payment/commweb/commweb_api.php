 ...
 *
 * @author Andrew Dubbeld (support@commweb.com.au)
 * @date 19-Oct-2009
 */
/* Modes */
...
/* Server URLs */
define('SECUREPAY_URL_TEST', 'https://www.commweb.com.au/test/payment');
define('SECUREPAY_URL_LIVE', 'https://www.commweb.com.au/xmlapi/payment');
define('SECUREPAY_URL_PERIODIC_TEST', 'https://www.commweb.com.au/test/periodic');
define('SECUREPAY_URL_PERIODIC_LIVE', 'https://www.commweb.com.au/xmlapi/periodic');
define('SECUREPAY_URL_FRAUD_TEST', 'https://www.commweb.com.au/antifraud_test/payment');
define('SECUREPAY_URL_FRAUD_LIVE', 'https://www.commweb.com.au/antifraud/payment');
...
class commweb_xml_transaction {
    ...
    private function responseToArray($responseMessage) {
        $xmlres = array();
        $xmlres = $this->xml_to_array($responseMessage, 0);
